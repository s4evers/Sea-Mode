...
**Основные** CSS Анимации fishMovement: Управляет анимацией плавания рыбки .boatMovement: Управляет покачиванием лодки .rotateSun: Вращает солнце на небе .swingCloud: Двигает облака горизонтально.
